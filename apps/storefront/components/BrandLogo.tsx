...
const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  // Signature Orizino 3-Wing Geometric Emblem
  return (
    <div className={`relative inline-flex items-center justify-center shrink-0 aspect-[539/565] ${className}`} style={style}>
      <svg
        viewBox="0 0 539.27 565.14"
        className="w-full h-full overflow-visible fill-current text-foreground transition-colors"
