...
const LAYOUT_CONFIGS: Record<LayoutStyle, LayoutConfigTokens> = {
  "dark-luxury": {
    ...
    cardClass: "bg-zinc-900/70 border border-amber-500/20 backdrop-blur-xl rounded-3xl shadow-none",
  ...
  glass: {
    ...
    cardClass: "bg-card/75 border border-border/80 backdrop-blur-xl rounded-3xl shadow-none",
  ...
  neon: {
    ...
    cardClass: "bg-black/70 border border-primary/40 backdrop-blur-xl shadow-none rounded-3xl",
  ...
  magazine: {
    ...
    cardClass: "bg-card/60 border border-border/60 backdrop-blur-md rounded-2xl shadow-none",
  ...
  "glass-minimal": {
    ...
    cardClass: "bg-card/50 border border-border/50 backdrop-blur-md rounded-3xl shadow-none",
    accentBorder: "border-border/60",
