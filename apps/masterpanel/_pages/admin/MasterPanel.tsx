...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "BrandHome Landing",url: "/brand/landing",         icon: Presentation },
      { label: "Docs / Legal",    url: "/brand/docs",             icon: FileText },
      { label: "News & Blog",     url: "/brand/news",             icon: Megaphone },
      { label: "Order Tracking",  url: "/brand/track",            icon: Truck },
      { label: "Scanner Info",    url: "/brand/scanner-info",     icon: ScanLine },
