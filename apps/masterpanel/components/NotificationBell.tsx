      ...
      {typeof document !== "undefined" && createPortal(
        <AnimatePresence>
          ...
          <motion.div
            ...
            className={`fixed z-[1000] w-80 max-h-[420px]`}
            style={{
              top: `${panelPosition.top}px`,
              right: `${panelPosition.right}px`,
            }}
          >
            <div className="rounded-2xl border border-border/60 shadow-xl overflow-hidden bg-card/98 dark:bg-[hsl(var(--charcoal-mid)/0.98)] backdrop-blur-xl">
              <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-card/90 dark:bg-[hsl(var(--charcoal)/0.95)]">
