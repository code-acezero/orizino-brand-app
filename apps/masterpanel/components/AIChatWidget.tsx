...
import { X, Send, Bot, User, Headphones, Phone, PhoneOff, Mic, MicOff, AlertTriangle, MessageSquare, ChevronDown, Paperclip, Smile } from "lucide-react";
...
const AIChatWidget: React.FC = () => {
  ...
  const isAdminPage = location.pathname === "/" || location.pathname.startsWith("/sales") || location.pathname.startsWith("/marketing") || location.pathname.startsWith("/affiliate") || location.pathname.startsWith("/brand") || location.pathname.startsWith("/system") || location.pathname.startsWith("/settings-ai") || location.pathname.startsWith("/team");
