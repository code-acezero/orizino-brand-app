    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Showcase",        url: "/sales/showcase" },
        ],
      },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { title: "Content",  url: "/brand/landing?tab=content" },
          { title: "Sections", url: "/brand/landing?tab=sections" },
        ],
      },
      {
        title: "Home Page",
        ...
        children: [
          { title: "Dashboard",         url: "/brand/home?tab=dashboard" },
          { title: "Analytics",         url: "/brand/home?tab=analytics" },
          {
            title: "Section order",
            url: "/brand/home?tab=section-order",
            children: [
              { title: "Display Sections",    url: "/brand/home?tab=section-order&panel=order" },
              { title: "Featured Categories", url: "/brand/home?tab=section-order&panel=feat-categories" },
              { title: "Featured Products",   url: "/brand/home?tab=section-order&panel=feat-products" },
            ],
          },

          { title: "Category sections", url: "/brand/home?tab=cat-sections" },
          { title: "Sales",             url: "/brand/home?tab=sales" },
          { title: "New arrivals",      url: "/brand/home?tab=new-arrivals" },
          { title: "Layout & style",    url: "/brand/home?tab=layout" },
        ],
      },
      {
        title: "CMS Pages",
        ...
        children: [
          { title: "Visual",   url: "/brand/cms-pages?panel=visual" },
          { title: "Markdown", url: "/brand/cms-pages?panel=markdown" },
        ],
      },
