  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        section: "ai",
        adminOnly: true,
        description: "Autonomous customer assistant, greeting widget & AI intelligence configuration",
        keywords: "ai agent assistant bot concierge prompt gemini",
      },
      {
        ...
        section: "ai",
        adminOnly: true,
        description: "Neural collaborative filtering & AI discover engine rerank",
        keywords: "recommendations discover personalization ai rerank neural cart upsell",
      },
      {
        title: "Social & Chat Automations",
        url: "/settings-ai/social-automations",
        icon: MessageSquare,
        section: "settings",
        adminOnly: true,
        description: "Unified multi-channel automation hub for WhatsApp, Facebook, Instagram & TikTok",
        keywords: "chat automations social whatsapp facebook instagram tiktok meta messenger dm shop auto reply",
        children: [
          { title: "All Integrations Hub", url: "/settings-ai/social-automations" },
          { title: "WhatsApp Cloud API",   url: "/settings-ai/social-automations?tab=whatsapp" },
          { title: "Facebook Messenger",   url: "/settings-ai/social-automations?tab=facebook" },
          { title: "Instagram Direct",     url: "/settings-ai/social-automations?tab=instagram" },
          { title: "TikTok Shop & DM",     url: "/settings-ai/social-automations?tab=tiktok" },
          { title: "Automation Rules",     url: "/settings-ai/social-automations?tab=rules" },
        ],
      },
      {
        title: "SMS Gateway",
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        section: "employees",
        adminOnly: true,
        description: "Staff roster, designations & section access",
        keywords: "employees staff roster team roles access sections permissions",
      },
      {
        title: "Departments",
        url: "/team/teams",
        ...
        section: "employees",
        adminOnly: true,
        description: "Manage department teams, members & access",
        keywords: "teams departments groups staff access sections permissions",
      },
      {
        title: "My Department",
        url: "/team/my-team",
        icon: Briefcase,
        description: "View your department membership and section access",
        keywords: "my team department membership sections access teammates",
      },
      {
        title: "Permissions",
        url: "/team/access",
        ...
        section: "employees",
        adminOnly: true,
        description: "Grant / revoke section permissions & manage role presets",
      ...
      },
      {
        ...
        section: "employees",
        adminOnly: true,
        description: "Real-time security audit log and permission history",
        keywords: "security log audit trail activity history permissions",
      },
    ],
  },
];
